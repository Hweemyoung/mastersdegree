...
if __name__ == '__main__':
    ...
    # youtube_search = search_by_q("scopus/scopus_life+earch_top60_1901.csv", column="Redirection")
    ...
    # upload_rel_paper_video("rel_paper_video", "results/search/search_20200816_224613.txt")
    # youtube_videos = videos_by_video_ids("results/search/search_20200816_224613.txt")
    update_videos_by_list_videos("scopus_videos_2019_life", "./results/videos/videos_20200816_225237.txt", filter_by_q=True, overwrite=True)
