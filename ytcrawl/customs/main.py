...
if __name__ == '__main__':
    ...
    # search_by_q("scopus/scopus_math+comp_top5perc_1406.csv", column="Redirection")
    # upload_rel_paper_video("rel_paper_video", "results/search/search_20200725_135753.txt")
    # videos_by_video_ids("results/search/search_20200725_135753.txt")
    # update_videos_by_list_videos('scopus_videos', './results/videos/videos_20200725_140523.txt', filter_by_q=True, overwrite=True)
